...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ asset('Assets/Back/img/favicon.ico') }}" rel="icon">
    ...
    <link href="{{ asset('Assets/Back/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css') }}" rel="stylesheet" />

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('Assets/Back/css/bootstrap.min.css') }}" rel="stylesheet">

    <script src="{{ asset('Assets/Back/lib/ckeditor/ckeditor.js') }}"></script>
    <!-- Template Stylesheet -->
    <link href="{{ asset('Assets/Back/css/style.css') }}" rel="stylesheet">

    <script src="{{ url('Assets/Back/lib/ckeditor/ckeditor.js') }}"></script>
</head>
...
<body>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{ asset('Assets/Back/img/user.jpg') }}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="{{ route('products.create') }}" class="dropdown-item">Add Products</a>
                            <a href="{{ route('category.index') }}" class="dropdown-item">Add Category</a>
                            <a href="{{ route('material.index') }}" class="dropdown-item">Add Strap Material</a>
                        </div>
                    </div>

                    <a href="{{ route('brand.index') }}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Brand</a>

                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-store me-2"></i>Page Style</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ route('mainSlide.index') }}" class="dropdown-item">Main Slide</a>
                        </div>
                    </div>

                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-user-tie me-2"></i>Users</a>
                        <div class="dropdown-menu bg-transparent border-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="{{ asset('Assets/Back/img/user.jpg') }}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="{{ url('https://htmlcodex.com') }}">HTML Codex</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('Assets/Back/js/varient.js') }}"></script>
</body>
